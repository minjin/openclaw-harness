...
| 文档 | 内容 |
|---|---|
| [docs/REQUIREMENTS.md](docs/REQUIREMENTS.md) | 需求：背景、目标与非目标、场景、功能与非功能需求、验收标准 |
| [docs/DESIGN.md](docs/DESIGN.md) | 设计：架构、状态机、流水线定义、执行器适配、权限模型、外脑、规则接线、测试策略 |
| [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md) | 开发思路：调研结论、关键取舍与否决方案、真机测试收获、已知限制、路线图、如何扩展 |
